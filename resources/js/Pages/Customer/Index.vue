<template>
    <AppLayout title="Customer">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    >
                        <div
                            class="flex justify-between items-center py-4 bg-white dark:bg-gray-800"
                        >
                            <div class="ml-5">
                                <PrimaryButton
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td
                                        class="py-4 px-6 flex items-center justify-center gap-3"
                                    >
                                        <button
                                            class="text-blue-500"
        ...
        <Modal :show="showCreateModal">
            ...
            >
                <div class="my-5 text-xl text-center font-bold uppercase">
                    Create transaction
                </div>
                ...
                <div class="w-full px-5">
                    ...
                    />
                    <InputError
                        :message="createForm.errors.number"
                        class="mt-1"
                    />
                </div>
        ...
        <Modal :show="showUpdateModal">
            ...
            >
                <div class="my-5 text-xl text-center font-bold uppercase">
                    Update {{ updateForm.name }}'s schedule
                </div>
                ...
                <div class="w-full px-5">
                    ...
                    />
                    <InputError
                        :message="updateForm.errors.number"
                        class="mt-1"
                    />
                </div>

                <div class="mt-10 px-5 flex justify-end gap-3">
                    <SecondaryButton @click="showUpdateModal = false"
                        >Cancel</SecondaryButton
                    >
                    <PrimaryButton type="submit">Save</PrimaryButton>
                </div>
        ...
        <Modal :show="showDeleteModal">
            ...
            >
                <div
                    class="mt-10 text-center flex items-center justify-center gap-3"
                >
                    <div
                    ...
                    Do you really want to delete {{ updateForm.name }}'s
                    account?
                </div>
                <div class="mt-10 px-5 flex justify-end gap-3">
...
const onUpdateSubmit = () => {
    updateForm.put(route("customers.update", updateForm.id), {
        onSuccess: () => {
            updateForm.reset();
...
const onDeleteSubmit = () => {
    ...
    //     }
    // });
    Inertia.delete(route("customers.destroy", deleteForm.id));
